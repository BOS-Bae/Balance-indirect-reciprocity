...
plt.plot(N_arr,np.zeros(len(N_arr)),color='black')
plt.errorbar(N_arr, Diff_arr_L6,yerr=std_err_L6,color="midnightblue",capsize=5)
...
plt.plot(N_arr, abs(Diff_arr_L4),color="blue",marker='s')
plt.errorbar(N_arr, abs(Diff_arr_L4),yerr=std_err_L4,color="blue",capsize=5)
plt.xlabel("N",fontsize=25)
plt.ylabel("η/N",fontsize=25)
plt.xlim(3,N_f)
plt.ylim(0,1)
